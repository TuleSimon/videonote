...
class OverlayScreenIos extends StatefulWidget {
  const OverlayScreenIos({super.key,
  ...
  @override
  State<OverlayScreenIos> createState() => _OverlayScreenState();
}

class _OverlayScreenState extends State<OverlayScreenIos> {
